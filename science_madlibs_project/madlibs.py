...
def print_importance(noun1, noun2):
...
def get_results_data(percentage):
...
#Print Abstract
def print_abstract(noun1, noun2, location, num, tool, adverb1, pastverb, adj):
	print("ABSTRACT:")
	print("_" * 40)
	...
	print(f"{adverb1} {pastverb} whenever confronted with a {noun1} that's {adj}. ")

#Print Introduction
def print_intro(noun1, noun2, adverb1, pastverb, animal, color, material, happy_verb):
	print("INTRODUCTION:")
	print("_" * 40)
...
#Print Methods
def print_methods_output(tool, noun2, noun1, num):
	print("METHODS:")
	print("_" * 40)
...
#Print Results
def print_results_output(percentage, noun2, adverb1, pastverb, noun1, correlated, animal, color, material, percentage2):
	print("RESULTS: ")
	print("_" * 40)
...
def main():
	author = get_author()
	noun1, noun2, location, adverb1, tool, pastverb = get_study_conditions()
	num = get_num()
	percentage, percentage2 = get_percentages()

	print_importance(noun1, noun2)
	animal, color, material, happy_verb = get_animal_data()
	print_methods(animal)
	
	correlated, adj = get_results_data(percentage)
	print_abstract(noun1, noun2, location, num, tool, adverb1, pastverb, adj)
